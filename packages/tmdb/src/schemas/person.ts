 ...
 */
export class PersonDetails extends Schema.Class<PersonDetails>('PersonDetails')({
  id: Schema.Number,
  name: Schema.String,
  biography: Schema.String,
  birthday: Schema.NullOr(Schema.String),
  deathday: Schema.NullOr(Schema.String),
  placeOfBirth: Schema.propertySignature(Schema.NullOr(Schema.String)).pipe(Schema.fromKey('place_of_birth')),
  ...
  alsoKnownAs: Schema.propertySignature(Schema.Array(Schema.String)).pipe(Schema.fromKey('also_known_as')),
  adult: Schema.Boolean,
  imdbId: Schema.propertySignature(Schema.String).pipe(Schema.fromKey('imdb_id')),
}) {}

/**
 * Movie credit cast schema
 */
export class MovieCreditCast extends Schema.Class<MovieCreditCast>('MovieCreditCast')({
  id: Schema.Number,
  title: Schema.String,
  ...
  creditId: Schema.propertySignature(Schema.String).pipe(Schema.fromKey('credit_id')),
}) {}

/**
 * Movie credit crew schema
 */
export class MovieCreditCrew extends Schema.Class<MovieCreditCrew>('MovieCreditCrew')({
  id: Schema.Number,
  title: Schema.String,
  job: Schema.String,
 ...
 */
export class PersonMovieCredits extends Schema.Class<PersonMovieCredits>('PersonMovieCredits')({
  id: Schema.Number,
 ...
 */
export class PersonTvCredits extends Schema.Class<PersonTvCredits>('PersonTvCredits')({
  id: Schema.Number,
...
const CombinedCreditCastMovie = Schema.Struct({
  ...
  mediaType: Schema.propertySignature(Schema.Literal('movie')).pipe(Schema.fromKey('media_type')),
})

const CombinedCreditCastTv = Schema.Struct({
  ...TvCreditCast.fields,
  mediaType: Schema.propertySignature(Schema.Literal('tv')).pipe(Schema.fromKey('media_type')),
})

export const CombinedCreditCast = Schema.Union(CombinedCreditCastMovie, CombinedCreditCastTv)
export type CombinedCreditCast = Schema.Schema.Type<typeof CombinedCreditCast>
...
export const CombinedCreditCrew = Schema.Union(CombinedCreditCrewMovie, CombinedCreditCrewTv)
export type CombinedCreditCrew = Schema.Schema.Type<typeof CombinedCreditCrew>

/**
 * Person combined credits schema
 */
export class PersonCombinedCredits extends Schema.Class<PersonCombinedCredits>('PersonCombinedCredits')({
  id: Schema.Number,
 ...
 */
export class PersonPopularResult extends Schema.Class<PersonPopularResult>('PersonPopularResult')({
  id: Schema.Number,
  name: Schema.String,
  profilePath: Schema.propertySignature(Schema.NullOr(Schema.String)).pipe(Schema.fromKey('profile_path')),
  knownForDepartment: Schema.propertySignature(Schema.String).pipe(Schema.fromKey('known_for_department')),
  ...
  knownFor: Schema.propertySignature(
    Schema.Array(
      Schema.Struct({
        id: Schema.Number,
        mediaType: Schema.propertySignature(Schema.Union(Schema.Literal('movie'), Schema.Literal('tv'))).pipe(
 ...
 */
export class PersonPopularResponse extends Schema.Class<PersonPopularResponse>('PersonPopularResponse')({
  page: Schema.Number,
