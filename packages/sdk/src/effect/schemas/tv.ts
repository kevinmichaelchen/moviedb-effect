 ...
 */
export class TvShowDetails extends Schema.Class<TvShowDetails>('TvShowDetails')({
  id: Schema.Number,
  name: Schema.String,
  ...
  lastAirDate: Schema.propertySignature(Schema.String).pipe(Schema.fromKey('last_air_date')),
  numberOfSeasons: Schema.propertySignature(Schema.Number).pipe(Schema.fromKey('number_of_seasons')),
  numberOfEpisodes: Schema.propertySignature(Schema.Number).pipe(Schema.fromKey('number_of_episodes')),
  ...
  type: Schema.String,
  inProduction: Schema.propertySignature(Schema.Boolean).pipe(Schema.fromKey('in_production')),
}) {}
 ...
 */
export class TvShowListResult extends Schema.Class<TvShowListResult>('TvShowListResult')({
  id: Schema.Number,
  name: Schema.String,
  originalName: Schema.propertySignature(Schema.String).pipe(Schema.fromKey('original_name')),
  overview: Schema.String,
 ...
 */
export class TvShowListResponse extends Schema.Class<TvShowListResponse>('TvShowListResponse')({
  page: Schema.Number,
